...
export function renderHomePage (proxySettings, hostName, isPassSet, panelVersion, defaultHttpPorts, defaultHttpsPorts) {
    const {
        remoteDNS,
        localDNS,
        vlessTrojanFakeDNS,
...
export function renderLoginPage (panelVersion) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
...
export function renderErrorPage (message, error, refer, panelVersion) {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
